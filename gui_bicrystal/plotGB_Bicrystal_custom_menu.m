...
uimenu(menuBX_CPFEM, 'Label', 'Indentation test in a bicrystal', ...
    'Callback', 'A_preCPFE_windows_indentation_setting_BX(guidata(gcf),0)');
...
uimenu(menuBX_CPFEM, 'Label', 'Scratch test in a bicrystal', ...
    'Callback', 'A_preCPFE_windows_indentation_setting_BX(guidata(gcf),1)');
uimenu(menuBX_CPFEM, 'Label', 'Scratch test in a Grain A', ...
    'Callback', 'A_preCPFE_windows_indentation_setting_BX(guidata(gcf),1,1)');
uimenu(menuBX_CPFEM, 'Label', 'Scratch test in a Grain B', ...
    'Callback', 'A_preCPFE_windows_indentation_setting_BX(guidata(gcf),1,2)');
