...
if gui.flag.error == 0
    ...
    if get(gui.handles.pmchoicecase, 'Value') < 8 || get(gui.handles.pmchoicecase, 'Value') > 29
        gui.calculations.mprime_val_bc_all = zeros(gui.calculations.vectB(1,9,gui.GB.GrainB), gui.calculations.vectA(1,9,gui.GB.GrainA));
    ...
    elseif get(gui.handles.pmchoicecase, 'Value') > 7 && get(gui.handles.pmchoicecase, 'Value') < 15
        gui.calculations.residual_Burgers_vector_val_bc_all = zeros(gui.calculations.vectB(1,9,gui.GB.GrainB), gui.calculations.vectA(1,9,gui.GB.GrainA));
        for jj = 1:1:gui.calculations.vectB(1,16,gui.GB.GrainB)
            for kk = 1:1:gui.calculations.vectA(1,16,gui.GB.GrainA)
                ...
                gui.flag.flag_dir_vectA = zeros(gui.calculations.vectB(1,9,gui.GB.GrainB), gui.calculations.vectA(1,9,gui.GB.GrainA));
                gui.flag.flag_dir_vectB = zeros(gui.calculations.vectB(1,9,gui.GB.GrainB), gui.calculations.vectA(1,9,gui.GB.GrainA));
                if ind == 1
    ...
    elseif get(gui.handles.pmchoicecase, 'Value') > 14 && get(gui.handles.pmchoicecase, 'Value') < 22
        gui.calculations.n_fact_val_bc_all = zeros(gui.calculations.vectB(1,9,gui.GB.GrainB), gui.calculations.vectA(1,9,gui.GB.GrainA));
        for jj = 1:1:gui.calculations.vectB(1,16,gui.GB.GrainB)
            for kk = 1:1:gui.calculations.vectA(1,16,gui.GB.GrainA)
    ...
    elseif get(gui.handles.pmchoicecase, 'Value') > 21 && get(gui.handles.pmchoicecase, 'Value') < 29
        gui.calculations.LRB_val_bc_all = zeros(gui.calculations.vectB(1,9,gui.GB.GrainB), gui.calculations.vectA(1,9,gui.GB.GrainA));
        for jj = 1:1:gui.calculations.vectB(1,16,gui.GB.GrainB)
            for kk = 1:1:gui.calculations.vectA(1,16,gui.GB.GrainA)
