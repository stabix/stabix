            ...
            for jj = 1:1:gui.calculations.vectB(1,16,gui.GB.GrainB)
                for kk = 1:1:gui.calculations.vectA(1,16,gui.GB.GrainA)
                    ...
                    rbv_bc_val(2) = residual_Burgers_vector(...
                        ...
                        gui.calculations.vectB(jj,10:12,gui.GB.GrainB));
                    %rbv_bc_val(3) = residual_Burgers_vector(gui.calculations.vectA(kk,10:12,GB.GrainA), gui.calculations.vectB(jj,13:15,GB.GrainB));
                    %rbv_bc_val(4) = residual_Burgers_vector(gui.calculations.vectA(kk,13:15,GB.GrainA), gui.calculations.vectB(jj,13:15,GB.GrainB));
