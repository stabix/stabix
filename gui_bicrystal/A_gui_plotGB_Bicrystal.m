...
gui.handles.txtEulAngGrB = uicontrol(...
    'Parent', gui.handles.Bicrystal_interface,...
    'Units', 'normalized',...
    'Style', 'text',...
...
gui.handles.getEulangGrA = uicontrol(...
    'Parent', gui.handles.Bicrystal_interface,...
    'Units', 'normalized',...
    'Style', 'edit',...
...
gui.handles.getEulangGrB = uicontrol(...
    'Parent', gui.handles.Bicrystal_interface,...
    'Units', 'normalized',...
    'Style', 'edit',...
...
[gui.handles.txtGBinclination, gui.handles.getGBinclination] = ...
    plotGB_Bicrystal_gbind_prop({'GB Inclination (°)'}, '', ...
    [0.04 0.88 0.22 0.025], 'plotGB_Bicrystal');

%% Setting of GB trace
[gui.handles.txtGBtrace, gui.handles.getGBtrace] = ...
    plotGB_Bicrystal_gbind_prop({'GB Trace Ang. (°)'}, ...
    '', [0.04 0.85 0.22 0.025], 'plotGB_Bicrystal');

%% Miller indices of slip in grain A and slip in grain B (normal and direction)
[gui.handles.txtSlipA, gui.handles.getSlipA] = ...
    plotGB_Bicrystal_slip_def({'Slip_A'}, '1', ...
    [0.04 0.77 0.07 0.025], 'plotGB_Bicrystal');
[gui.handles.txtSlipB, gui.handles.getSlipB] =  ...
    plotGB_Bicrystal_slip_def({'Slip_B'}, '1',  ...
    [0.04 0.74 0.07 0.025], 'plotGB_Bicrystal');
...
%% IPF plot
gui.handles.pbIPFplotAB = uicontrol( ...
    'Parent', gui.handles.Bicrystal_interface,...
    'Units', 'normalized',...
    'Style', 'pushbutton',...
    'Position', [0.04 0.805 0.16 0.04],...
    'String', 'IPF Gr.A and Gr. B',...
...
gui.handles.cb_all_values_map = uicontrol( ...
    'Parent', gui.handles.Bicrystal_interface,...
    'Units', 'normalized',...
    'Style', 'pushbutton',...
