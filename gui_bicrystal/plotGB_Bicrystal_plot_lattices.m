...
elseif valplot == 4  %% Plot of Burgers vectors
    ...
    if strfind(version('-release'), '2014')
        arrow_grA = line([shiftXYZA(1) shiftXYZA(1)+slipdirectionA*radius/2], ...
            [shiftXYZA(2) shiftXYZA(2)+slipdirectionA*radius/2], ...
            [shiftXYZA(3) shiftXYZA(3)+slipdirectionA*radius/2], ...
            'Color', arrowcolora, 'LineWidth',4);
        arrow_grB  = line([shiftXYZB(1) shiftXYZB(1)+slipdirectionB*radius/2], ...
            [shiftXYZB(2) shiftXYZB(2)+slipdirectionB*radius/2], ...
            [shiftXYZB(3) shiftXYZB(3)+slipdirectionB*radius/2], ...
        ...
        arrow_grA = arrow(shiftXYZ_A, shiftXYZ_A+slipdirectionA*radius, ...
            'FaceColor', arrowcolora, 'Length', 5, 'TipAngle', 15);
        arrow_grB = arrow(shiftXYZ_B, shiftXYZ_B+slipdirectionB*radius, ...
            'FaceColor', arrowcolorb, 'Length', 5, 'TipAngle', 15);
    end
end
