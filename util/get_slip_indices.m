...
% $Id: get_slip_indices.m 1204 2014-08-05 13:29:53Z d.mercier $
function specific_slip = get_slip_indices(specific_slip_unstrcat_str, slip_all_vect, norm_or_dir, varargin)
...
for ii = 1:1:size(slip_all_vect, 3)
    ...
    if strcmp(specific_slip_unstrcat_str, slipA_all_vect_str(norm_or_dir,:,ii)) == 1
        specific_slip = ii;
        flag_match = 1;
        break;
    end
...
if ~flag_match
    display('No matching between slip system given by user and slip system database');
end
