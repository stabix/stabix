...
function handles = gui_gbinc_buttons_load_set_image(x0, hu, wu, image, filename_picture)
...
str_calibration = strcat('CALIBRATION #', num2str(image));
callback_calibration = strcat('gui_gbinc_scale_calibration(', num2str(image),')');
...
handles.scale_value = uicontrol('Parent', parent,...
    'Units', 'normalized',...
    'Style', 'edit',...
    'Position', [x0+wu*3.2 hu*3.6 wu*2 x0*10],...
    'String', '100',...
    'BackgroundColor', [1 1 1]);
...
handles.scale_unit = uicontrol('Parent', parent,...
    'Units', 'normalized',...
    'Style', 'text',...
    'Position', [x0+wu*5.2 hu*3.6 wu*1.2 x0*10],...
    'String', 'µm',...
    'HorizontalAlignment', 'left');
...
handles.scale_factor_str = uicontrol('Parent', parent,...
    'Units', 'normalized',...
    'Style', 'text',...
    'Position', [x0+wu*6.5 hu*4.5 wu*3 x0*10],...
    'String', 'Factor scale',...
    'HorizontalAlignment','left');
...
handles.scale_factor_value = uicontrol('Parent', parent,...
    'Units', 'normalized',...
    'Style', 'edit',...
    'Position', [x0+wu*6.5 hu*3.6 wu*2 x0*10],...
    'String', '',...
    'BackgroundColor', [1 1 1]);
...
handles.scale_factor_unit = uicontrol('Parent', parent,...
    'Units', 'normalized',...
    'Style', 'text',...
    'Position', [x0+wu*8.5 hu*3.6 wu*1.2 x0*10],...
    'String', 'µm/pixel',...
    'HorizontalAlignment', 'left');
