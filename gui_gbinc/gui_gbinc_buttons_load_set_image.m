...
%% Calibration
handles.pb_Calibration_distance = set_pushbutton(...
    'CALIBRATION DISTANCE', [x0 hu*3.5 wu*3 x0*20], ...
    callback_calibration_dist, h);

handles.pb_Calibration = set_pushbutton(...
    'SET', [x0*32 hu*3.5 wu*1.5 x0*20], ...
    callback_calibration, h);
...
%% Edge detection
handles.pb_edge_detection = set_pushbutton(...
    str_edge_detection, [x0 hu wu*3 x0*20], ...
    callback_edge_detection, h);
