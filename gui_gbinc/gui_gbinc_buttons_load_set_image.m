...
%% Loading
handles.pb_ImpImage = set_pushbutton(...
    str_loading, [x0 hu*8 wu*9.75 x0*20], ...
    callback_loading, h);
...
%% Calibration
handles.pb_Calibration_distance = set_pushbutton('CALIBRATION DISTANCE', ...
    [x0 hu*3.5 wu*3 x0*20], callback_calibration_dist, h);

handles.pb_Calibration = set_pushbutton('SET', ...
    [x0*32 hu*3.5 wu*1.5 x0*20], callback_calibration, h);
...
handles.scale_factor_unit = uicontrol('Parent', parent,...
    ...
    'String', 'microns/pixel');

%% Edge detection
handles.pb_edge_detection = set_pushbutton(str_edge_detection, ...
    [x0 hu wu*3 x0*20], callback_edge_detection, h);

[handles.edge_detection_algo_str, handles.edge_detection_algo] = ...
    set_popupmenu('Algorithm', [x0+wu*3.2 hu*2.1 wu*3 x0*7], ...
    1, listEdgeDetection, callback_edge_detection, h);
...
set([handles.edit_ImpImageFile, handles.scale_str,...
    ...
    handles.edge_detection_algo_str,...
