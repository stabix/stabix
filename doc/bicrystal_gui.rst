...
or set by the user (directly inside the bicrystal GUI or by loading a `YAML config. bicrystal <https://github.com/czambaldi/stabix/tree/master/gui_bicrystal/gui_bicrystal_data/Kacher2012/Kacher2012_Fig.12.yaml>`_ file from the menu).

The |matlab| function used to run the bicrystal GUI is: `A_gui_plotGB_Bicrystal.m <https://github.com/czambaldi/stabix/tree/master/gui_bicrystal/A_gui_plotGB_Bicrystal.m>`_
