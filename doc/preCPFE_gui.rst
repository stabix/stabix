...
`F. Han et al., "Experiments and crystal plasticity finite element simulations of nanoindentation on Ti-6Al-4 V alloy.", Materials Science & Engineering A (2014) <http://dx.doi.org/10.1016/j.msea.2014.11.090>`_
