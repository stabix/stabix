...
if ~isdir(gui_SX.config_CPFEM.proc_file_path)
    gui_SX.config_CPFEM.proc_file_path = fullfile(getenv('SLIP_TRANSFER_TBX_ROOT'), '');
    beep;
...
if strfind(gui_SX.config_CPFEM.fem_solver_used, 'Abaqus') == 1
