...
%py{end+1} = sprintf('Indentation.MENTATVERSION = %.1f', gui_SX.config_CPFEM.fem_solver_used); 
py{end+1} = sprintf('Indentation.MENTATVERSION = ''%s''', gui_SX.config_CPFEM.fem_solver_used); 
