...
function [X, Y, data, fvc, handle_indenter] = ...
    preCPFE_3d_indenter_topo_AFM(...
    topo, h_indent, smooth_factor, z_factor, varargin)
...
if smooth_flag
    for ii = 1:1:topo.nX/smooth_factor
        for jj = 1:1:topo.nY/smooth_factor
            topo.X_smoothed(ii,jj) = ...
                mean([topo.X(smooth_factor*ii-1,2*jj-1),...
            ...
            topo.Y_smoothed(ii,jj) = ...
                mean([topo.Y(smooth_factor*ii-1,2*jj-1),...
            ...
            topo.data_smoothed(ii,jj) = ...
                mean([topo.data(smooth_factor*ii-1,2*jj-1),...
    ...
    topo.data_smoothed = ...
        (-(topo.data_smoothed - max(max(topo.data_smoothed)))) - h_indent;
else
