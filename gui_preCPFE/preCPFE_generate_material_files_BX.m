...
elseif strcmp(CPFEM_code, 'DAMASK') == 1
    ...
    damask_python_path = strrep(fullfile(gui_BX.config.CPFEM.python4fem_module_path, 'damask'), '\', '\\');
    
    fid = fopen(scriptname_DAMASK_materialconfig,'w+');
    fprintf(fid, '# Generated by preCPFE_generate_material_files.m --- DO NOT EDIT\n');
    ...
    cmd = sprintf('%s %s', gui_BX.config.CPFEM.python_executable, fullfile(pwd, scriptname_DAMASK_materialconfig));
    commandwindow;
    system(cmd);
