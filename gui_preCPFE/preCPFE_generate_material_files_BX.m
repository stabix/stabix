...
function preCPFE_generate_material_files_BX(CPFEM_code, varargin)
...
if strcmp(CPFEM_code, 'GENMAT') == 1
    ...
    fid = fopen(fullfile(gui_BX.path_config_file, ...
    ...
    fprintf(fid, '1, %s, %s, %s, 0, 0.50, 1\n', ...
        num2str(gui_BX.GB.eulerA(1)), ...
        num2str(gui_BX.GB.eulerA(2)), ...
        num2str(gui_BX.GB.eulerA(3)));
    fprintf(fid, '#2 Data for Grain %s\n', num2str(gui_BX.GB.GrainB));
    fprintf(fid, '6, 6, 18, 1, 0\n');
    fprintf(fid, '1, %s, %s, %s, 0, 0.50, 1\n', ...
        num2str(gui_BX.GB.eulerB(1)), ...
        num2str(gui_BX.GB.eulerB(2)), ...
        num2str(gui_BX.GB.eulerB(3)));
    fclose(fid);
...
elseif strcmp(CPFEM_code, 'DAMASK') == 1
    ...
    scriptname_DAMASK_materialconfig = sprintf(...
        '%s_DAMASK_materialconfig.py', gui_BX.GB.Titlegbdatacompl);
    damask_python_path = strrep(fullfile(...
        gui_BX.config.CPFEM.python4fem_module_path, 'damask'), '\', '\\');
    ...
    fprintf(fid, 'p=''%s'' \n', ...
        gui_BX.config.CPFEM.python4fem_module_path);
