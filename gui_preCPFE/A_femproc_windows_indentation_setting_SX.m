...
gui_SX.handles.pm_Python = uicontrol( ...
    ...
    'FontSize', 10,...
    'HorizontalAlignment', 'center', ...
    'Callback', 'gui_SX = guidata(gcf); gui_SX.config_CPFEM.python_executable = femproc_python_select; guidata(gcf, gui_SX)');
...
guidata(gcf, gui_SX);
gui_SX.config_CPFEM.python_executable = femproc_python_select;
guidata(gcf, gui_SX);
