...
[handles.D_sample_str, handles.D_sample_val]           = femproc_set_inputs_boxes({'D_sample (µm)'}, [x0 hu*16.9 wu*3 hu/2.5], mesh_variables.variables.D_sample, 'femproc_indentation_setting_SX');
[handles.h_sample_str, handles.h_sample_val]           = femproc_set_inputs_boxes({'h_sample (µm)'}, [x0 hu*16.3 wu*3 hu/2.5], mesh_variables.variables.h_sample, 'femproc_indentation_setting_SX');
[handles.r_center_frac_str, handles.r_center_frac_val] = femproc_set_inputs_boxes({'r_center_frac'}, [x0 hu*15.7 wu*3 hu/2.5], mesh_variables.variables.r_center_frac, 'femproc_indentation_setting_SX');
[handles.box_xfrac_str, handles.box_xfrac_val]         = femproc_set_inputs_boxes({'box_xfrac'}, [x0 hu*15.1 wu*3 hu/2.5], mesh_variables.variables.box_xfrac, 'femproc_indentation_setting_SX');
[handles.box_zfrac_str, handles.box_zfrac_val]         = femproc_set_inputs_boxes({'box_zfrac'}, [x0 hu*14.5 wu*3 hu/2.5], mesh_variables.variables.box_zfrac, 'femproc_indentation_setting_SX');
