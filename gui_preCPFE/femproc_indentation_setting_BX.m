...
if gui_BX.config_CPFEM.user_setting == 0
    set(gui_BX.handles.pb_CPFEM_model, 'BackgroundColor', [229/256 20/256 0],...
        'String', 'No user config. file found !', ...
        'Callback', '');
end

if gui_BX.config_CPFEM.python_exe_path == 0
    set(gui_BX.handles.pb_CPFEM_model, 'BackgroundColor', [229/256 20/256 0],...
        'String', 'No Python exec. found !', ...
        'Callback', '');
end

if gui_BX.config_CPFEM.user_setting == 1 && gui_BX.config_CPFEM.python_exe_path == 1
    set(gui_BX.handles.pb_CPFEM_model, 'BackgroundColor', [0.2 0.8 0],...
        'String', 'CPFE  model',...
