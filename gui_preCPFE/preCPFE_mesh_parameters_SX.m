...
if strfind(fem_software, 'Abaqus')
    [handles.box_bias_x_str, handles.box_bias_x_val]       = preCPFE_set_inputs_boxes({'box_bias_x (not 0)'}, [x0 hu*11.5 wu*3 hu/2.5], mesh_variables.variables.box_bias_x_abaqus, 'preCPFE_indentation_setting_SX');
    [handles.box_bias_z_str, handles.box_bias_z_val]       = preCPFE_set_inputs_boxes({'box_bias_z (not 0)'}, [x0 hu*10.9 wu*3 hu/2.5], mesh_variables.variables.box_bias_z_abaqus, 'preCPFE_indentation_setting_SX');
    [handles.box_bias_conv_x_str, handles.box_bias_conv_x_val] = preCPFE_set_inputs_boxes({'box_bias_conv_x (not 0)'}, [x0 hu*10.3 wu*3 hu/2.5], mesh_variables.variables.box_bias_conv_x_abaqus, 'preCPFE_indentation_setting_SX');
