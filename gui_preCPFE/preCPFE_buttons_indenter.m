...
[handles.coneAngle_str, handles.coneAngle_val] = ...
    set_inputs_boxes({'Full Angle of conical indenter (°)'}, ...
...
[handles.h_indent_str,  handles.h_indent_val]  = ...
    set_inputs_boxes({'Indentation depth (µm)'}, ...
...
handles.load_AFM = set_pushbutton('Load AFM', ...
    [22*x0+wu*3 hu*16.7 wu*1 hu*0.6], ...
...
handles.rotate_loaded_indenter_box = uicontrol('Parent', parent,...
    ...
    'Position', [22*x0+3.01*wu hu*15.5 wu*0.5 hu*0.5],...
    'String', '0',...
    'Style', 'text',...
...
handles.rotate_loaded_indenter_unit = uicontrol('Parent', parent,...
    'Units', 'normalized',...
    'Position', [22*x0+3.57*wu hu*15.5 wu*0.05 hu*0.5],...
    'Style', 'text',...
    'String', '°',...
