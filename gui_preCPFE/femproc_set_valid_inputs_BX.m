...
if gui_BX.variables.w_sample < 0
    ...
    set(gui_BX.handles.mesh.w_sample_val, 'String', num2str(gui_BX.variables.w_sample));
elseif gui_BX.variables.w_sample == 0
    set(gui_BX.handles.mesh.w_sample_val, 'String', num2str(gui_BX.defaults.variables.w_sample));
...
if gui_BX.variables.h_sample < 0
    ...
    set(gui_BX.handles.mesh.h_sample_val, 'String', num2str(gui_BX.variables.h_sample));
elseif gui_BX.variables.h_sample == 0
    set(gui_BX.handles.mesh.h_sample_val, 'String', num2str(gui_BX.defaults.variables.h_sample));
...
if gui_BX.variables.len_sample < 0
    ...
    set(gui_BX.handles.mesh.len_sample_val, 'String', num2str(gui_BX.variables.len_sample));
elseif gui_BX.variables.len_sample == 0
    set(gui_BX.handles.mesh.len_sample_val, 'String', num2str(gui_BX.defaults.variables.len_sample));
...
if gui_BX.variables.inclination < 0
    ...
    set(gui_BX.handles.mesh.inclination_val, 'String', num2str(gui_BX.variables.inclination));
elseif gui_BX.variables.inclination == 0 || gui_BX.variables.inclination > 180
    set(gui_BX.handles.mesh.inclination_val, 'String', num2str(gui_BX.defaults.variables.inclination));
...
if gui_BX.variables.box_elm_nx <= 0
    ...
    gui_BX.variables.box_elm_nx = str2num(get(gui_BX.handles.mesh.box_elm_nx_val, 'String'));
end
...
if gui_BX.variables.box_elm_nz <= 0
    ...
    gui_BX.variables.box_elm_nz = str2num(get(gui_BX.handles.mesh.box_elm_nz_val, 'String'));
end
...
if gui_BX.variables.box_elm_ny1 <= 0
    ...
    gui_BX.variables.box_elm_ny1 = str2num(get(gui_BX.handles.mesh.box_elm_ny1_val, 'String'));
end
