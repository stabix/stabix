...
if gui_BX.variables.coneAngle < 0
    ...
    set(gui_BX.handles.mesh.coneAngle_val, 'String', num2str(gui_BX.variables.coneAngle));
end

% Indent depth
if gui_BX.variables.h_indent < 0
    gui_BX.variables.h_indent = abs(gui_BX.variables.h_indent);
    set(gui_BX.handles.mesh.h_indent_val, 'String', num2str(gui_BX.variables.h_indent));
end
...
if gui_BX.variables.box_bias_x < -0.5 || gui_BX.variables.box_bias_x > 0.5
    set(gui_BX.handles.mesh.box_bias_x_val, 'String', num2str(gui_BX.variables.box_bias_x_init));
...
if gui_BX.variables.box_bias_z < -0.5 || gui_BX.variables.box_bias_z > 0.5
    set(gui_BX.handles.mesh.box_bias_z_val, 'String', num2str(gui_BX.variables.box_bias_z_init));
...
if gui_BX.variables.box_bias_y1 < -0.5 || gui_BX.variables.box_bias_y1 > 0.5
    set(gui_BX.handles.mesh.box_bias_y1_val, 'String', num2str(gui_BX.variables.box_bias_y1_init));
...
if gui_BX.variables.box_bias_y2 < -0.5 || gui_BX.variables.box_bias_y2 > 0.5
    set(gui_BX.handles.mesh.box_bias_y2_val, 'String', num2str(gui_BX.variables.box_bias_y2_init));
...
if gui_BX.variables.box_bias_y3 < -0.5 || gui_BX.variables.box_bias_y3 > 0.5
    set(gui_BX.handles.mesh.box_bias_y3_val, 'String', num2str(gui_BX.variables.box_bias_y3_init));
