...
gui_BX.handles.pm_indenter_mesh_quality = uicontrol('Parent', gui_BX.handles.gui_BX_win,...
    'Units', 'normalized',...
...
gui_BX.handles.rotate_loaded_indenter_str = uicontrol('Parent', gui_BX.handles.gui_BX_win,...
    'Units', 'normalized',...
...
gui_BX.handles.rotate_loaded_indenter = uicontrol('Parent', gui_BX.handles.gui_BX_win,...
    'Units', 'normalized',...
    'Style', 'slider',...
