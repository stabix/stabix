...
pythons = {gui_BX.config_CPFEM.python.location, gui_BX.config_CPFEM.python.which{:}};
gui_BX.handles.pm_Python = uicontrol( ...
    'Units', 'normalized',...
    'Position', [2*x0 hu*2.6 wu*3 hu],...
    ...
    'FontSize', 10,...
    'HorizontalAlignment', 'center', ...
    'Callback', 'gui_BX = guidata(gcf); gui_BX.config_CPFEM.python_executable = femproc_python_select; guidata(gcf, gui_BX)');

%% Pop-up menu to set FEM software
gui_BX.handles.pm_FEM_interface = uicontrol('Parent', gui_BX.handles.gui_BX_win,...
    'Units', 'normalized',...
    'Position', [2*x0 hu*2 wu*3 hu],...
    'Style', 'popup',...
