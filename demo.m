...
gui.handles.MainWindow = figure('NumberTitle', 'off',...
    ...
    'Position', figure_position([0.02 0.3 pixelwidth2normalizedwidth(300) 1.6]), ...
    'MenuBar', 'none', ...
    'ToolBar', 'none');
...
gui.handles.title_GUI = uicontrol('Parent', gui.handles.MainWindow,...
    ...
    'String', {[gui.config.toolbox_name, ' ', gui.version_str], gui.description},...
    'FontWeight', 'bold',...
    'FontSize', 12,...
...
btm = btm - 2.1*hu;
gui.handles.pbgbinc_interface = uicontrol('Parent', gui.handles.MainWindow,...
    'Units', 'normalized',...
    'Style', 'pushbutton',...
...
set([gui.handles.pb_help, gui.handles.pb_sourcecode, gui.handles.pb_contact], ...
    'FontWeight','bold');
