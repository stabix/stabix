...
uimenu(menu_map, 'Label', 'Show GB conventions', 'Callback', 'gui = guidata(gcf); web(gui.config.path_picture_BXconv)', 'Separator', 'on');
uimenu(menu_map, 'Label', 'Edit this GUI', 'Callback', 'edit(''A_gui_plotmap'')', 'Separator', 'on');
uimenu(menu_map, 'Label', 'Help', 'Callback', 'gui = guidata(gcf); web(gui.config.doc_path)','Separator','on');
