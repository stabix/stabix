...
uimenu(menu_map, 'Label', 'Show GB conventions', 'Callback', 'gui = guidata(gcf); webbrowser(fullfile(gui.config.doc_path_root, gui.config.doc_path_BXconv_png))', 'Separator', 'on');
