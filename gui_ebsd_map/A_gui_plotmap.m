...
[gui.handles.Unit_title, gui.handles.pm_unit] = ...
    set_popupmenu('Unit', [0.23 0.85 0.06 0.02], ...
    1, listLengthUnit, 'interface_map_plotmap(0);');
...
[gui.handles.Grain_totalnumber_title, gui.handles.Grain_totalnumber_value] ...
    = set_inputs_boxes('Number of GBs :', [0.42 0.97 0.13 0.02], ...
    '', '', 0.8);
