...
gui.handles.pbPlotEBSDMap = uicontrol(...
    ...
    'Callback', ['try interface_map_MTEX_plotEBSDdata(ebsd);' ...
    'catch helpdlg(''Save ebsd as a variable in the Matlab workspace, ' ...
    'when loading ang. file...''); end']);
...
gui.handles.pbPlotStatGrain = uicontrol(...
    ...
    'visible', 'off',... % 'on' when .ang data are loaded by user using MTEX routine
    'Callback', ['try interface_map_MTEX_plotGrainsStat(ebsd);' ...
    'catch helpdlg(''Save ebsd as a variable in the Matlab workspace, ' ...
    'when loading ang. file...''); end']);
...
gui.handles.ST_s11 = uicontrol('Parent', gui.handles.TSLinterfWindow, ...
    ...
    'Callback', callback_stress_tensor);
...
gui.handles.cbunitcell = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'checkbox',...
...
gui.handles.cbdatavalues = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'checkbox',...
...
gui.handles.cbsliptraces = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'checkbox',...
...
gui.handles.param2Scale4GBs = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'text',...
    'HorizontalAlignment', 'left',...
...
gui.handles.pmparam2plot4GB = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'popupmenu',...
...
gui.handles.param2Scale4Grains = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'text',...
    'HorizontalAlignment', 'left',...
...
gui.handles.pmparam2plot4Grains = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'popupmenu',...
...
gui.handles.cblegend = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'checkbox',...
...
gui.handles.numGB2plot = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'edit',...
    'BackgroundColor', [0.9 0.9 0.9],...
...
gui.handles.pbGBplot = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'pushbutton',...
...
gui.handles.GB_totalnumber_title = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',....
    'Style', 'text',...
    'HorizontalAlignment', 'left',...
...
gui.handles.GB_totalnumber_value = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'edit',...
    'BackgroundColor', [0.9 0.9 0.9],...
...
gui.handles.Grain_totalnumber_title = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',....
    'Style', 'text',...
    'HorizontalAlignment', 'left',...
...
gui.handles.Grain_totalnumber_value = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'edit',...
    'BackgroundColor', [0.9 0.9 0.9],...
...
gui.handles.pbsave_newGBs = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'pushbutton',...
