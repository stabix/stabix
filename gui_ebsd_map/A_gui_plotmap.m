...
gui.handles.pbFileScanData = uicontrol(...
    ...
    'Callback', ['MTEX_getEBSD; gui = guidata(gcf);' ...
...
gui.handles.pbPlotEBSDMap = uicontrol(...
    ...
    'Callback', ['try MTEX_plotEBSDdata(ebsd);' ...
...
gui.handles.pbPlotStatGrain = uicontrol(...
    ...
    'visible', 'off',... % 'on' when .ang data are loaded by user using MTEX routine
    'Callback', ['try MTEX_plotGrainsStat(ebsd);' ...
    'catch helpdlg(''Save ebsd as a variable in the Matlab workspace, ' ...
    'when loading ang. file...''); end']);
...
gui.handles.pbclose = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'pushbutton',...
    'Position', [0.15 0.03 0.06 0.05],...
    'String', 'CLOSE',...
    'Callback', 'close_windows(gcf);');
