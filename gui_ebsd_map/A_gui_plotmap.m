...
if ~isfield(gui.config_map, 'TSLOIM_data_path_GF2')
    gui.config_map.TSLOIM_data_path_GF2 = ...
        gui.config_map.path_to_EBSD_data_examples;
end
...
gui.handles.Choice_material_title = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'text',...
...
gui.handles.Choice_material_pm = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'popupmenu',...
...
gui.handles.Choice_sample_title = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'text',...
...
gui.handles.Choice_sample_pm = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'popupmenu',...
...
gui.handles.cb_rdm_TSLdata = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'checkbox',...
...
gui.handles.pbFileGF2 = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'pushbutton',...
...
gui.handles.pbFileRB = uicontrol(...
    'Parent',gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'pushbutton',...
...
gui.handles.Eul_title = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'text',...
...
gui.handles.pmcoordsyst = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'popupmenu',...
...
gui.handles.Unit_title = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'text',...
...
gui.handles.pm_unit = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'popupmenu',...
    'Position', [0.23 0.83 0.06 0.02],...
    'BackgroundColor', [0.9 0.9 0.9],...
    'String', listLengthUnit,...
    'Value', 2,...
    'Callback', 'interface_map_plotmap(0);');

%% Plot EBSD map (all grains)
gui.handles.pbFileScanData = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'pushbutton',...
...
gui.handles.pbPlotEBSDMap = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'pushbutton',...
...
gui.handles.pbPlotStatGrain = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'pushbutton',...
...
gui.handles.Settings = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'text',...
...
gui.handles.NumPh_title = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'text',...
...
%[gui.handles.Mat1, gui.handles.pmMat1, gui.handles.Struct1, gui.handles.pmStruct1, gui.handles.listslips1, gui.handles.pmlistslips1] = interface_map_material('#1', [0.02 0.67 0.11 0.02], 'gui = guidata(gcf); set(gui.handles.pmparam2plot4GB, ''Value'', 1); set(gui.handles.pmparam2plot4Grains, ''Value'', 1); gui.flag.new_slip_families = 1; guidata(gcf, gui); interface_map_plotmap', 'gui = guidata(gcf); set(gui.handles.pmparam2plot4GB, ''Value'', 1); set(gui.handles.pmparam2plot4Grains, ''Value'', 1); gui.flag.new_slip_families = 1; guidata(gcf, gui); interface_map_plotmap(1,1);');
...
% parameter to plot, but impossible to do a multiple selection of slip
% systems in the list...
[gui.handles.Mat1, gui.handles.pmMat1, gui.handles.Struct1,...
    ...
    [0.02 0.67 0.11 0.02], 'gui = guidata(gcf); set(gui.handles.pmparam2plot4GB, ''Value'', 1); set(gui.handles.pmparam2plot4Grains, ''Value'', 1); gui.flag.new_slip_families = 1; guidata(gcf, gui); interface_map_plotmap', 'gui = guidata(gcf); gui.flag.new_slip_families = 1; guidata(gcf, gui); interface_map_plotmap(1,1);');
...
[gui.handles.Mat2, gui.handles.pmMat2, gui.handles.Struct2, ...
    ...
    [0.15 0.67 0.11 0.02], 'gui = guidata(gcf); set(gui.handles.pmparam2plot4GB, ''Value'', 1); set(gui.handles.pmparam2plot4Grains, ''Value'', 1); gui.flag.new_slip_families = 1; guidata(gcf, gui); interface_map_plotmap', 'gui = guidata(gcf); gui.flag.new_slip_families = 1; guidata(gcf, gui); interface_map_plotmap(1,1);');
...
gui.handles.ST_s11 = uicontrol('Parent', gui.handles.TSLinterfWindow, ...
    'Units', 'normalized', 'BackgroundColor', [0.9 0.9 0.9], ...
    'Position', [0.02 0.440 0.03 0.02], 'String', '0', 'Style', 'edit', ...
    'Callback', 'gui = guidata(gcf); set(gui.handles.pmparam2plot4GB, ''Value'', 1); set(gui.handles.pmparam2plot4Grains, ''Value'', 1); guidata(gcf, gui); interface_map_plotmap(0);');
gui.handles.ST_s12 = uicontrol('Parent', gui.handles.TSLinterfWindow, ...
    'Units', 'normalized', 'BackgroundColor', [0.9 0.9 0.9], ...
    'Position', [0.06 0.440 0.03 0.02], 'String', '0', 'Style', 'edit', ...
    'Callback', 'gui = guidata(gcf); set(gui.handles.pmparam2plot4GB, ''Value'', 1); set(gui.handles.pmparam2plot4Grains, ''Value'', 1); guidata(gcf, gui); interface_map_plotmap(0);');
gui.handles.ST_s13 = uicontrol('Parent', gui.handles.TSLinterfWindow, ...
    'Units', 'normalized', 'BackgroundColor', [0.9 0.9 0.9], ...
    'Position', [0.10 0.440 0.03 0.02], 'String', '0', 'Style', 'edit', ...
    'Callback', 'gui = guidata(gcf); set(gui.handles.pmparam2plot4GB, ''Value'', 1); set(gui.handles.pmparam2plot4Grains, ''Value'', 1); guidata(gcf, gui); interface_map_plotmap(0);');
gui.handles.ST_s21 = uicontrol('Parent', gui.handles.TSLinterfWindow, ...
    'Units', 'normalized', 'BackgroundColor', [0.9 0.9 0.9], ...
    'Position', [0.02 0.415 0.03 0.02], 'String', '0', 'Style', 'edit', ...
    'Callback', 'gui = guidata(gcf); set(gui.handles.pmparam2plot4GB, ''Value'', 1); set(gui.handles.pmparam2plot4Grains, ''Value'', 1); guidata(gcf, gui); interface_map_plotmap(0);');
gui.handles.ST_s22 = uicontrol('Parent', gui.handles.TSLinterfWindow, ...
    'Units', 'normalized', 'BackgroundColor', [0.9 0.9 0.9], ...
    'Position', [0.06 0.415 0.03 0.02], 'String', '0', 'Style', 'edit', ...
    'Callback', 'gui = guidata(gcf); set(gui.handles.pmparam2plot4GB, ''Value'', 1); set(gui.handles.pmparam2plot4Grains, ''Value'', 1); guidata(gcf, gui); interface_map_plotmap(0);');
gui.handles.ST_s23 = uicontrol('Parent', gui.handles.TSLinterfWindow, ...
    'Units', 'normalized', 'BackgroundColor', [0.9 0.9 0.9], ...
    'Position', [0.10 0.415 0.03 0.02], 'String', '0', 'Style', 'edit', ...
    'Callback', 'gui = guidata(gcf); set(gui.handles.pmparam2plot4GB, ''Value'', 1); set(gui.handles.pmparam2plot4Grains, ''Value'', 1); guidata(gcf, gui); interface_map_plotmap(0);');
gui.handles.ST_s31 = uicontrol('Parent', gui.handles.TSLinterfWindow, ...
    'Units', 'normalized', 'BackgroundColor', [0.9 0.9 0.9], ...
    'Position', [0.02 0.390 0.03 0.02], 'String', '0', 'Style', 'edit', ...
    'Callback', 'gui = guidata(gcf); set(gui.handles.pmparam2plot4GB, ''Value'', 1); set(gui.handles.pmparam2plot4Grains, ''Value'', 1); guidata(gcf, gui); interface_map_plotmap(0);');
gui.handles.ST_s32 = uicontrol('Parent', gui.handles.TSLinterfWindow, ...
    'Units', 'normalized', 'BackgroundColor', [0.9 0.9 0.9], ...
    'Position', [0.06 0.390 0.03 0.02], 'String', '0', 'Style', 'edit', ...
    'Callback', 'gui = guidata(gcf); set(gui.handles.pmparam2plot4GB, ''Value'', 1); set(gui.handles.pmparam2plot4Grains, ''Value'', 1); guidata(gcf, gui); interface_map_plotmap(0);');
gui.handles.ST_s33 = uicontrol('Parent', gui.handles.TSLinterfWindow, ...
    'Units', 'normalized', 'BackgroundColor', [0.9 0.9 0.9], ...
    'Position', [0.10 0.390 0.03 0.02], 'String', '1', 'Style', 'edit', ...
    'Callback', 'gui = guidata(gcf); set(gui.handles.pmparam2plot4GB, ''Value'', 1); set(gui.handles.pmparam2plot4Grains, ''Value'', 1); guidata(gcf, gui); interface_map_plotmap(0);');

% Stress is symmetric
set([gui.handles.ST_s21, gui.handles.ST_s31, gui.handles.ST_s32], ...
    'Enable','off');
...
gui.handles.titlecolorbar = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'text',...
...
gui.handles.pmcolorbar = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'popupmenu',...
...
gui.handles.titlecolorbar_loc = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'text',...
...
gui.handles.pmcolorbar_loc = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'popupmenu',...
...
gui.handles.pbclearall = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'pushbutton',...
...
gui.handles.pbfinishsav = uicontrol(...
    'Parent', gui.handles.TSLinterfWindow,...
    'Units', 'normalized',...
    'Style', 'pushbutton',...
