...
[gui.handles.Mat1, gui.handles.pmMat1, gui.handles.Struct1, gui.handles.pmStruct1, gui.handles.listslips1, gui.handles.pmlistslips1] = interface_map_material('#1', [0.02 0.67 0.11 0.02], 'gui = guidata(gcf); set(gui.handles.pmparam2plot4GB, ''Value'', 1); set(gui.handles.pmparam2plot4Grains, ''Value'', 1); gui.flag.new_slip_families = 1; guidata(gcf, gui); interface_map_plotmap(0)', 'gui = guidata(gcf); set(gui.handles.pmparam2plot4GB, ''Value'', 1); set(gui.handles.pmparam2plot4Grains, ''Value'', 1); gui.flag.new_slip_families = 1; guidata(gcf, gui); interface_map_plotmap(0);');
